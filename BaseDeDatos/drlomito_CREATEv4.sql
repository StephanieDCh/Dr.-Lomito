...
CREATE TABLE IF NOT EXISTS `drlomito`.`usuarios` (
  ...
  `tipo_usuario_tipo_usuario_id` BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `drlomito`.`info_veterinario` (
  `info_veterinario_id` BIGINT NOT NULL AUTO_INCREMENT,
  ...
  `veterinario_costo_consulta` DOUBLE NOT NULL,
  `veterinario_servicios` VARCHAR(300) NOT NULL,
  `categoria_vet_categoria_id` BIGINT NOT NULL,
  `usuarios_usuario_id` BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `drlomito`.`opiniones_vet` (
  `opiniones_id` BIGINT NOT NULL AUTO_INCREMENT,
